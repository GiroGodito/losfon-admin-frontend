...
export const DisposalItemsPage = () => {
  ...
  const hasItems = pagination.totalCount > 0;
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            title={isEmpty ? 'No disposal items' : undefined}
          >
            Mark All as Seen
          </Button>
          ...
          <Button
            ...
            disabled={isEmpty || isLoading || isDonating}
            title={isEmpty ? 'No disposal items to donate' : undefined}
          >
            Donate All
          </Button>
        </div>
      ...
      <ConfirmDialog
        ...
        onConfirm={handleDonateAll}
        title="Donate All Items"
        message={`Are you sure you want to donate ${pagination.totalCount} disposal item${pagination.totalCount === 1 ? '' : 's'} to charity? This action cannot be undone.`}
        confirmLabel="Donate All"
        variant="warning"
      />
