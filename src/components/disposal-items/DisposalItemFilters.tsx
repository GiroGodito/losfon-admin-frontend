// src/components/disposal-items/DisposalItemFilters.tsx
...
interface DisposalItemFiltersProps {
  onFilter: (filters: DisposalItemsQueryParams) => void;
  initialFilters?: DisposalItemsQueryParams;
  isLoading?: boolean;
}

export const DisposalItemFilters: React.FC<DisposalItemFiltersProps> = ({
  onFilter,
  initialFilters = {},
  isLoading = false,
}) => {
