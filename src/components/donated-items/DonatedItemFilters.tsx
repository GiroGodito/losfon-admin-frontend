// src/components/donated-items/DonatedItemFilters.tsx
...
interface DonatedItemFiltersProps {
  onFilter: (filters: DonatedItemsQueryParams) => void;
  initialFilters?: DonatedItemsQueryParams;
  isLoading?: boolean;
}

export const DonatedItemFilters: React.FC<DonatedItemFiltersProps> = ({
  onFilter,
  initialFilters = {},
  isLoading = false,
}) => {
  ...
  const [sortBy, setSortBy] = useState(initialFilters.sortBy || 'DonationDate');
