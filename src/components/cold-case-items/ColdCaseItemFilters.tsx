// src/components/cold-case-items/ColdCaseItemFilters.tsx
...
interface ColdCaseItemFiltersProps {
  onFilter: (filters: ColdCaseItemsQueryParams) => void;
  initialFilters?: ColdCaseItemsQueryParams;
  isLoading?: boolean;
}

export const ColdCaseItemFilters: React.FC<ColdCaseItemFiltersProps> = ({
  onFilter,
  initialFilters = {},
  isLoading = false,
}) => {
  ...
  const [sortBy, setSortBy] = useState(initialFilters.sortBy || 'DateTransferred');
